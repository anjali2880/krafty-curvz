...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-5 md:mb-6">
        ...
        <div>
            ...
            <h1 class="mt-1 text-2xl md:text-3xl font-bold text-gray-950">Create Category</h1>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 pt-4">
                    ...
                    <button type="submit" class="inline-flex justify-center px-4 py-2.5 bg-amber-700 hover:bg-amber-800 text-white rounded-lg text-sm font-medium">Create Category</button>
                </div>
            </div>
        </form>
    </div>
