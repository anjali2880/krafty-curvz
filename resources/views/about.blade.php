...
>
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-3xl sm:text-4xl font-bold text-white mb-3 md:mb-5">Our Creative Journey</h1>
        <p class="text-base md:text-lg text-white max-w-2xl mx-auto">Where passion meets creativity in every handcrafted piece.</p>
    </div>
</section>

<section class="py-10 md:py-16 bg-[#f5f2ed]">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-7 md:gap-10 items-center">
        <div>
            <h2 class="text-3xl md:text-4xl font-bold text-[#5f3c2a] mb-4 md:mb-6">Our Story</h2>
            <div class="space-y-3 md:space-y-4 text-[#4a4a4a] leading-7 md:leading-8">
...
<section class="py-10 md:py-16 bg-[#f5f2ed]">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-soft px-5 py-8 md:px-12 md:py-12">
            <div class="text-center mb-7 md:mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-[#5f3c2a]">Our Core Values</h2>
                <div class="w-20 h-0.5 bg-amber-500 mx-auto mt-4"></div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <div class="text-center p-4 md:p-6 rounded-xl hover:bg-amber-50/40 transition-colors duration-300">
...
<section class="py-10 md:py-16 bg-[#f5f2ed]">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-7 md:mb-12 max-w-2xl mx-auto">
            <p class="text-sm uppercase tracking-[0.25em] text-amber-700 font-semibold">The Team</p>
            <h2 class="text-3xl md:text-5xl font-bold text-[#5f3c2a] mt-2 md:mt-3">Meet Our Artists</h2>
            <p class="text-gray-600 mt-3 md:mt-4">The hands and hearts behind every custom resin piece, candle, and craft detail.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 items-stretch">
