...
<body class="bg-neutral-50 text-neutral-900 min-h-screen antialiased">
    <!-- Modern Header -->
    <header class="bg-[#fff7eb] border-b border-amber-100/80 backdrop-blur-md shadow-soft fixed top-0 left-0 right-0 z-50 transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://www.instagram.com/krafty_curvz/" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-primary-500/20 hover:bg-primary-500/30 rounded-lg flex items-center justify-center transition-all duration-300 group">
                            <svg class="w-5 h-5 text-primary-400 group-hover:text-primary-300" fill="currentColor" viewBox="0 0 24 24">
